...
This release is solely minor fixes and cleanup of the engine. In particular
the bootstrap/build process now clearly communicates C++11 requirement.

* Add `saxonhe_dir` action.
  -- _Richard Hodges_
* Add CI testing for historical Boost versions on Windows MSVC.
  -- _Rene Rivera_
* Check for C++11 support when building engine. Including aninformative
