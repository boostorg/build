...
if allow_properties("variant=debug", "link=shared", "runtime-link=shared"):
    ...
    command('icc', '-o', output_file('bin/intel-darwin-10.2/debug/target-os-darwin/libl1.dylib'), '-single_module', '-dynamiclib', '-install_name', 'libl1.dylib', input_file('bin/intel-darwin-10.2/debug/target-os-darwin/lib.o'), '-g', '-shared-intel', '-lstdc++', '-lpthread', '-fPIC')
    ...
    command('icc', '-o', output_file('bin/intel-darwin-10.2/debug/target-os-darwin/test'), input_file('bin/intel-darwin-10.2/debug/target-os-darwin/main.o'), input_file('bin/intel-darwin-10.2/debug/target-os-darwin/libl1.dylib'), '-g', '-shared-intel', '-lstdc++', '-lpthread', '-fPIC')
...
if allow_properties("variant=release", "link=shared", "runtime-link=shared"):
    ...
    command('icc', '-o', output_file('bin/intel-darwin-10.2/release/target-os-darwin/libl1.dylib'), '-single_module', '-dynamiclib', '-install_name', 'libl1.dylib', input_file('bin/intel-darwin-10.2/release/target-os-darwin/lib.o'), '-shared-intel', '-lstdc++', '-lpthread', '-fPIC')
    ...
    command('icc', '-o', output_file('bin/intel-darwin-10.2/release/target-os-darwin/test'), input_file('bin/intel-darwin-10.2/release/target-os-darwin/main.o'), input_file('bin/intel-darwin-10.2/release/target-os-darwin/libl1.dylib'), '-shared-intel', '-lstdc++', '-lpthread', '-fPIC')
...
if allow_properties("variant=debug", "link=static", "runtime-link=shared"):
    ...
    command('icc', '-o', output_file('bin/intel-darwin-10.2/debug/link-static/target-os-darwin/test'), input_file('bin/intel-darwin-10.2/debug/link-static/target-os-darwin/main.o'), input_file('bin/intel-darwin-10.2/debug/link-static/target-os-darwin/libl1.a'), '-g', '-shared-intel', '-lstdc++', '-lpthread')
...
if allow_properties("variant=debug", "link=shared", "runtime-link=shared", "architecture=x86", "address-model=32"):
    ...
    command('icc', '-o', output_file('bin/intel-darwin-10.2/debug/x86/target-os-darwin/libl1.dylib'), '-single_module', '-dynamiclib', '-install_name', 'libl1.dylib', input_file('bin/intel-darwin-10.2/debug/x86/target-os-darwin/lib.o'), '-g', '-shared-intel', '-lstdc++', '-lpthread', '-march=i686', '-fPIC', '-m32')
    ...
    command('icc', '-o', output_file('bin/intel-darwin-10.2/debug/x86/target-os-darwin/test'), input_file('bin/intel-darwin-10.2/debug/x86/target-os-darwin/main.o'), input_file('bin/intel-darwin-10.2/debug/x86/target-os-darwin/libl1.dylib'), '-g', '-shared-intel', '-lstdc++', '-lpthread', '-march=i686', '-fPIC', '-m32')
