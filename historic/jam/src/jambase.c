...
"\"There is an initial bootstrap file which attempted to load the build system,\"\n",
"\"with this call: 'boost-build\" $(dir) \";' but we were unable to find the secondary\"\n",
"\"bootstrap file to load.\"\n",
...
"\"Please consult the documentation at 'http://www.boost.org'.\" ;\n",
"}\n",
"BINDRULE on <jam-module>boost-base.jam = record-file-location ;\n",
...
"\"were located, but the build system is not defined.\"\n",
"\"Attempted to use, as the bootstrap, this file:\"\n",
"$(file-location.boost-build.jam)$(SLASH)boost-build.jam.\n",
"\"This means that even though that file was loaded it either failed\"\n",
"\"to directly load the build system files, or it failed to specify\"\n",
"\"where to find and load the files by calling the 'build-system [path] ;'\"\n",
"\"rule.\"\n",
"\"Please consult the documentation at 'http://www.boost.org'.\" ;\n",
"}\n",
"}\n",
